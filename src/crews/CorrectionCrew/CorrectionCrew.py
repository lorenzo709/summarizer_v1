...
# llm = LLM(model="ollama/llama4:scout", base_url="http://localhost:11434", timeout=None)
llm = LLM(model="ollama/qwen3.5:122b", base_url="http://localhost:11434", reasoning_effort='none', timeout=None)
