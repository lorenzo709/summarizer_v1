...
llm = LLM(model="ollama/llama4:scout", base_url="http://localhost:11434", temperature=0.1, timeout=1800)
# llm = LLM(model="ollama/qwen3.5:122b", base_url="http://localhost:11434", reasoning_effort='none')
