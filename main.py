...
OUTPUT_DIR = Path("./output_results_judge_on_single_summ")
...
class ResearcherFlow(Flow[ResearcherState]):
    ...
    def research_interesting_papers(self):
        ...
        folder_path = Path("./knowledge_platinum_water_splitting")
    ...
    async def aggregate_results(self):
        ...
        filename = OUTPUT_DIR / f"result_{TOPIC}_{MODEL}.json"
